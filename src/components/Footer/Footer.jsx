            ...
            <div className="grid wide">
                <div className="row" style={{ marginTop: '30px', marginBottom: '30px' }}>
                    <div className="col l-4">
                        <h1>Outerity</h1>
                        <p>
                            Chúng mình xuất hiện để đem tới mọi người một chất lượng áo
                            tốt nhất, với giá thành hấp dẫn nhất để đưa Outerity đến với
                            tất cả lứa tuổi và khắp mọi vùng miền đất nước
                        </p>
                    ...
                    <div className="col l-4">
                        ...
                        <div className="footer-contact-item">
                            <Room style={{ marginRight: '10px' }} /> The New Playground,
                            04 Phạm Ngũ Lão, quận 1, HCM
                        </div>
                        <div className="footer-contact-item">
