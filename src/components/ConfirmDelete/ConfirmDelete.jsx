    ...
    return (
        ...
        <div className='confirm-delete-container' style={{ display: noti }}>
            <div className='confirm-delete-wrapper'>
                <h1 className='confirm-delete-title'>Bạn chắc chắn muốn bỏ sản phẩm này ?</h1>

                <div className='confirm-delete-name-product'>{name}</div>

                <div className='confirm-delete-wrapper-button'>
                    <div className='confirm-delete-button-yes' onClick={() => handleClick('yes')}>Có</div>
                    <div className='confirm-delete-button-no' onClick={() => handleClick('no')}>Không</div>
                </div>
            </div>
        </div>
    );
